...
Then 
\begin{align}
a &= \eta + \log\left(\frac{2\pi}{\sqrt{N}}\right) \\
2b &= \left[\eta + \log\left(\frac{2\pi}{\sqrt{N}}\right)\right]^2 - \frac{\pi^2}{6} + \beta,
\end{align}
...
\begin{equation*}
\ldLe{1+s} = \frac{r_{an}}{s} + \left[\eta + \log\left(\frac{2\pi}{\sqrt{N}}\right)\right] + \left[-\zeta(2) + \sum_{\gamma\ne0} \gamma^{-2}\right]\cdot s + O(s^2)
\end{equation*}
