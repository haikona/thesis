...
Even though the above graph demonstrates that the zero dispersions are clearly not random, when viewed as a i.i.d. time series, the dispersions appear to limit to a constant Gaussian distribution. \\

% HISTOGRAM OF 389a ZERO DISPERSIONS HERE %
