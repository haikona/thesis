...
\end{proof}
We will later use a related technique to show firstly that the the factor in front of $\log N_E$ can be made arbitrarily small, at the expense of having to assume GRH and having to increase the added constant. \\
...
\begin{corollary}\label{cor:Re_logderiv}[GRH]
...
We won't say much more about bounding the error term in this thesis (or attemp to prove anything about its magnitude), since it requires more advanced analytical tools not mentioned or developed here. \\
